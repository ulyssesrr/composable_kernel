...
/opt/rocm/llvm/bin/opt -S -inline original.ll > inline.ll
/opt/rocm/llvm/bin/opt -S -sroa inline.ll > sroa.ll
/opt/rocm/llvm/bin/opt -S -O3 sroa.ll > o3.ll

/opt/rocm/llvm/bin/llc -mcpu=gfx1030 original.ll
/opt/rocm/llvm/bin/llc -mcpu=gfx1030 inline.ll
/opt/rocm/llvm/bin/llc -mcpu=gfx1030 sroa.ll
/opt/rocm/llvm/bin/llc -mcpu=gfx1030 o3.ll
