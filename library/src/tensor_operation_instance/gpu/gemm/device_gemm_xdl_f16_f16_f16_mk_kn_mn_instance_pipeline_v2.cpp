...
using device_gemm_xdl_f16_f16_f16_mk_kn_mn_instances_pipeline_v2 =
    std::tuple<
        // clang-format off
...
void add_device_gemm_xdl_f16_f16_f16_mk_kn_mn_instances_pipeline_v2(
    std::vector<std::unique_ptr<
        ...
        instances)
{
    add_device_operation_instances(instances, device_gemm_xdl_f16_f16_f16_mk_kn_mn_instances_pipeline_v2{});
}
