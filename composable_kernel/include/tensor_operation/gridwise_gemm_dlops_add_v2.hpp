#ifndef CK_GRIDWISE_GEMM_ADD_V2_HPP
#define CK_GRIDWISE_GEMM_ADD_V2_HPP
            ...
            const void CONSTANT* p_c_blockid_to_k_n_ho_wo_block_cluster_adaptor)
{
    ...
    const auto d_k_n_hox2_wox2_grid_desc = *reinterpret_cast<const DGridDesc_K_N_Hox2_Wox2*>(
        cast_pointer_to_generic_address_space(p_d_k_n_hox2_wox2_grid_desc));
...
template <index_t BlockSize,
          ...
          typename DGlobalDesc_K_N_Hox2_Wox2,
          ...
          index_t activ_type>
struct GridwiseGemmDlops_km_kn_mn_add_v3
{
                               ...
                               integral_constant<bool, HasDoubleTailE1BlockLoop>)
    {
        ...
        auto c_global_buf = make_dynamic_buffer<AddressSpaceEnum_t::Global>(
            p_c_global, d_k_n_hox2_wox2_global_desc.GetElementSpaceSize());
