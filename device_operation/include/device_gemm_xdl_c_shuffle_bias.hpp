...
struct DeviceGemmXdl_C_Shuffle_Bias
    : public DeviceGemmBias<AElementwiseOperation, BElementwiseOperation, CElementwiseOperation>
{
    ...
    struct Argument : public BaseArgument
    {
        ...
        {
            a_grid_desc_k0_m_k1_ =
                DeviceGemmXdl_C_Shuffle_Bias::MakeAGridDescriptor_K0_M_K1(M, K, StrideA);
            b_grid_desc_k0_n_k1_ =
                DeviceGemmXdl_C_Shuffle_Bias::MakeBGridDescriptor_K0_N_K1(K, N, StrideB);
            c0_grid_desc_m_n_ = DeviceGemmXdl_C_Shuffle_Bias::MakeC0GridDescriptor_M_N(M, N);
            c_grid_desc_m_n_ = DeviceGemmXdl_C_Shuffle_Bias::MakeCGridDescriptor_M_N(M, N, StrideC);
    ...
    {
        using Argument = DeviceGemmXdl_C_Shuffle_Bias::Argument;
        ...
        float Run(const Argument& arg, int nrepeat = 1)
        {
            ...
            if(has_main_k0_block_loop)
            {
                const auto kernel = kernel_gemm_xdlops_v3r2<
                    ...
                    CDataType,
                    remove_reference_t<DeviceGemmXdl_C_Shuffle_Bias::AGridDesc_K0_M_K1>,
                    remove_reference_t<DeviceGemmXdl_C_Shuffle_Bias::BGridDesc_K0_N_K1>,
                    remove_reference_t<
                        typename GridwiseGemm::
                            CGridDescriptor_MBlock_MXdlPerWave_MWaveMPerXdl_NBlock_NXdlPerWave_NWaveNPerXdl>,
                    remove_reference_t<
